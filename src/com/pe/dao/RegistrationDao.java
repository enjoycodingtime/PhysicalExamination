...
public class RegistrationDao {
	...
	public List<Registration> getRegistrateByRule(String rule, String value) throws Exception {
		// TODO Auto-generated method stub
		List<Registration> list = new ArrayList<Registration>();
		conn=DBUtil.getConnection();
		switch(rule) {
		case "id":
			...
			break; 
		case "name":
			String sql1 ="select * from registration where name=?";
		...
		case "sex":
			...
			String sql2 ="select * from registration where sex=?";
			ps =conn.prepareStatement(sql2);			
			ps.setString(1, sex);
			rs= ps.executeQuery();
			break;
		case "birthday":
			String sql3 ="select * from registration where birthday=?";
			ps =conn.prepareStatement(sql3);			
			ps.setString(1, value);
			rs= ps.executeQuery();
			break;
		case "phone_number":
			String sql4 ="select * from registration where phone_number=?";
			ps =conn.prepareStatement(sql4);			
			ps.setString(1, value);
			rs= ps.executeQuery();
			break;
		case "day":
			String sql5 ="select * from registration where date=?";
			ps =conn.prepareStatement(sql5);			
			ps.setString(1, value);
			rs= ps.executeQuery();
			break;
		case "combo":
			String sql6 ="select * from registration where combo=?";
